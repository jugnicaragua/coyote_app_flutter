...
abstract class Style {
  static const Color primaryColor = Color(0xff0895CB);
  static const MaterialColor primaryColorMaterial = MaterialColor(
    0xff0895CB,
    <int, Color>{
      50: Color(0xff0895CB),
      100: Color(0xff0895CB),
      200: Color(0xff0895CB),
      300: Color(0xff0895CB),
      400: Color(0xff0895CB),
      500: Color(0xff0895CB),
      600: Color(0xff0895CB),
      700: Color(0xff0895CB),
      800: Color(0xff0895CB),
      900: Color(0xff0895CB),
    },
  );

  static const Color textColor = Color(0xff444444);
  static const Color subTextColor = Color(0xff9e9e9e);
  static const Color bgColor = Color(0xff0895CB);
